    ...
    <div className="py-10 space-y-10">
      ...
      <section className="grid gap-8 md:grid-cols-2 items-center">
        <div className="space-y-3">
          ...
          <p className="text-sm md:text-base text-rosa-green-muted max-w-xl leading-relaxed">
            Unser Ziel ist es, jede Bestellung so persönlich wie möglich zu
            begleiten. Wir nehmen uns Zeit, hören zu und entwickeln gemeinsam
            mit dir eine Torte, die nicht nur geschmacklich überzeugt, sondern
            sich nach „dir“ anfühlt – individuell, liebevoll und einzigartig.
          </p>
        </div>

        {/* FOTO 1 */}
        <div className="group aspect-[4/5] md:aspect-[3/4] rounded-xl border border-[#D6CEA9]/60 overflow-hidden bg-white">
          <div
      ...
      {/* STORY BLOCK (informativa verde sólida) */}
      <section className="space-y-4">
        <div className="rounded-xl bg-white px-6 py-7 space-y-3 text-rosa-green">
          <h2 className="text-lg text-center md:text-xl font-semibold">
            Handgemacht, ehrlich und nahbar
          </h2>

          <p className="text-sm md:text-base text-rosa-green-muted leading-relaxed">
      ...
      <section className="grid gap-8 md:grid-cols-2 items-center">
        ...
        <div className="space-y-4">
          ...
          <ul className="text-sm text-rosa-green space-y-1">
      ...
      <section className="mt-16 rounded-xl bg-[#4D6936] border border-[#D6CEA9]/50 px-6 py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
